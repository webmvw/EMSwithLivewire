      ...
      <div class="col-md-12 col-sm-12">
        <div class="card">
			<div class="card-header d-flex justify-content-between">
				...
				<a href="{{route('admin.add.notice')}}" class="btn btn-sm btn-success">Add Notice</a>
			</div>
			<div class="card-body">
        ...
        @endif
              ...
              <td>
                <a href="{{route('admin.details.notice', $value->id)}}" title="Details" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                <a href="{{route('admin.edit.notice', $value->id)}}" title="Edit" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
